...
vim.keymap.set("i", "jk", "<ESC>l", { desc = "No hand move mapped ESC in insert mode", remap = true})
...
vim.keymap.set("n", "<leader>w<leader>", "<C-W>p", { desc = "Toggle between windows" })
vim.keymap.set("n", "<leader>W", "<C-W>c", { desc = "Close window" })
...
vim.keymap.set("n", "<leader>ee", ":MiniFilesOpen<cr>", { desc = "Open mini file explorer at buffer location" })
vim.keymap.set("n", "<leader>ew", ":MiniFilesWorkspace<cr>", { desc = "Open mini file explorer at cwd" })
